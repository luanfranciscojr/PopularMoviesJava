 ...
 */
public class DetailMoviePresenterImpl implements Callback<MovieDetailDTO>, DetailMoviePresenter {

    private  Retrofit retrofit;
    private  DetailMovieView view;

    @Inject
    public DetailMoviePresenterImpl(Retrofit retrofit, DetailMovieView view){
